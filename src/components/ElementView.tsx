...
export function ElementView({
	...
	const boxShadow = el.style.shadow
		? `${el.style.shadowX}px ${el.style.shadowY}px ${el.style.shadowBlur}px ${el.style.shadowColor}`
		: undefined;
	const baseStyle: React.CSSProperties = {
		...
		width: el.w,
		height: el.h,
		cursor: connecting ? "crosshair" : "move",
		userSelect: "none",
		opacity: el.style.opacity / 100,
		transform: el.style.rotation
