...
import { animate, stagger, onScroll, utils, scrambleText, createScope } from 'animejs'
...
function AnimatedLoginForSean() {
  ...
  useEffect(() => {
    ...
    animate(h1Ref.current!, {
      innerHTML: scrambleText({ text: "Welcome Sean, Hope this is interesting enough" }),
    });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 #b5c3ca #021822 flex items-center justify-center p-6 overflow-hidden relative">
      <div ref={orb1Ref} className="absolute w-96 h-96 #b5c3ca rounded-full blur-3xl opacity-30" />
      <div ref={orb2Ref} className="absolute w-96 h-96 b#021822 rounded-full blur-3xl opacity-30" />
      ...
      >
        <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-8 shadow-2xl">
          <h1 ref={h1Ref} className="text-3xl font-bold text-white mb-2">Welcome back</h1>
